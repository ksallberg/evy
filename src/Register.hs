...
module Register (registerPrompt) where
...
mkForm =
    ...
    in newForm [ label "Username" @@=
               ...
               , label "Password again" @@=
                   editPasswordField password2 Password2Field
               , label "Email" @@=
...
registerPrompt :: IO (String, String, String, String)
registerPrompt = do
    let buildVty = do
    ...
    return (T.unpack $ _name $ formState f',
            ...
            T.unpack $ _password2 $ formState f',
            T.unpack $ _email $ formState f')
